...
class lists(models.Model):
    ...
    list_tags = models.ManyToManyField(tags)
    list_users = models.ManyToManyField(User)
    list_creator = models.ForeignKey(User,on_delete=models.CASCADE, related_name = '+')
...
class stores(models.Model):
    ...
    store_address = models.ManyToManyField(addresses)
...
class items(models.Model):
    item_creator = models.ForeignKey(User, on_delete=models.CASCADE)
