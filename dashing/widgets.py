...
from data_manager import views, models
...
class Widget(JSONResponseMixin, View):
    def post(self, request, *args, **kwargs):
        context = json.dumps(self.get_context(args))
...
#         items = views.get_list_items(lists[1])
#         item = items[0]
#         itemName = item.item_name
#         self.data += [itemName]  #['the added item']

#         # This func works
#         #views.create_list(username, 'bitches')
