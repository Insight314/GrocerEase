...
(function(global, console) {
    ...
    Dashboard = function (options) {
        ...
        this.addWidget = function (name, type, options) {
            ...
            // This allows me to provide thess functions upon widget creation
            // self.subscribe(name + '/populate', widget.populate.bind(widget));
            // self.publish(name + '/populate');
            // self.subscribe(name + '/changeSize', widget.changeSize.bind(widget));
